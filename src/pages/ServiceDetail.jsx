      ...
      <div className="container mx-auto px-4 max-w-7xl relative z-20 -mt-24 mb-20">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="bg-white shadow-xl rounded-[2rem] p-8 flex flex-col items-center border border-gray-100 transition-transform hover:-translate-y-2">
            ...
            <h3 className="text-xl font-bold text-gray-900 mb-6 text-center">Core Features</h3>
          ...
          <div className="bg-white shadow-xl rounded-[2rem] p-8 flex flex-col items-center border border-gray-100 transition-transform hover:-translate-y-2">
            ...
            <h3 className="text-xl font-bold text-gray-900 mb-6 text-center">Key Benefits</h3>
            <ul className="space-y-4 w-full text-left flex-grow">
              {service.benefits?.map((benefit, idx) => (
                <li key={idx} className="flex items-start">
                  <CheckCircle2 size={18} className="text-[#ff5a00] mr-3 mt-0.5 flex-shrink-0" />
                  <span className="text-gray-600 font-medium text-sm leading-relaxed">{benefit}</span>
                </li>
              ))}
            </ul>
          </div>
          ...
          <div className="bg-white shadow-xl rounded-[2rem] p-8 flex flex-col items-center border border-gray-100 transition-transform hover:-translate-y-2">
            ...
            <h3 className="text-xl font-bold text-gray-900 mb-6 text-center">The Result</h3>
            <ul className="space-y-4 w-full text-left flex-grow">
              {service.results?.map((result, idx) => (
                <li key={idx} className="flex items-start">
                  <CheckCircle2 size={18} className="text-[#ff5a00] mr-3 mt-0.5 flex-shrink-0" />
                  <span className="text-gray-600 font-medium text-sm leading-relaxed">{result}</span>
                </li>
              ))}
            </ul>
          </div>
