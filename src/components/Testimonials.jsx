...
const Testimonials = () => {
  const reviews = [
    ...
    { name: "Owner", role: "HKGN Egg Shop", text: "They engineered a highly dynamic and optimized digital storefront for us. The interface is intuitive, and our customer retention has significantly improved." }
  ];
